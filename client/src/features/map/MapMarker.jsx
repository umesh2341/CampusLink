...
function MapMarker({ x, y, badgeCount = 0, isUnseen = true, active = false, onClick }) {
  ...
  const chipBase =
    'relative flex items-center justify-center px-2.5 py-1.5 sm:px-3 sm:py-2 border-2 border-ink rounded-xs font-mono text-sm sm:text-base font-bold leading-none tracking-tight shadow-hard transition-all duration-150 select-none cursor-pointer';
