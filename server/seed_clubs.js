    ...
    const clubsData = [
      {
        ...
        instagram: 'codingclub_iter', lead_name: 'Dev Lead',
        social_handles: JSON.stringify({ instagram: 'codingclub_iter', linkedin: 'codex-club-soa' })
      },
      {
      ...
      },
      {
        ...
        instagram: 'cultural_iter', lead_name: 'Cultural Sec',
      },
      {
        ...
        instagram: 'sports_iter', lead_name: 'Sports Captain',
      },
      {
